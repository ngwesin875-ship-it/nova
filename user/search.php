...
<main class="max-w-[1440px] mx-auto p-4 md:p-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
    <div class="lg:col-span-9 space-y-8">
        <div class="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500"><?= $total ?> result<?= $total !== 1 ? 's' : '' ?> found</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-10 shadow-sm text-center">
            <div class="text-4xl text-slate-300 mb-4"><i class="fa-solid fa-file-circle-exclamation"></i></div>
            <p class="text-slate-500 font-semibold">No articles found</p>
