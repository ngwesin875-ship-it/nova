                ...
                <form method="post" action="" class="p-5 space-y-5">
                    ...
                    <div class="grid md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="number" id="duration_months" name="duration_months" value="<?= (int) $durationMonths ?>" min="1" required class="w-full px-4 py-2.5 border border-gray-300 rounded-xl border-slate-300 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none">
                        </div>
                        <div>
                            <label for="price" class="block text-sm font-semibold text-gray-700 mb-1">Price (MMK) <span class="text-red-500">*</span></label>
                            <input type="number" id="price" name="price" value="<?= htmlspecialchars($price) ?>" step="0.01" min="0.01" required oninput="calcFinal()" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl border-slate-300 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none">
                        </div>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="number" id="discount_percentage" name="discount_percentage" value="<?= htmlspecialchars($discountPercentage) ?>" step="0.01" min="0" max="100" oninput="calcFinal()" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl border-slate-300 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none">
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        ...
                        <a href="plans.php" class="px-6 py-2.5 border border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-slate-50/80 transition-colors transition">Cancel</a>
                    </div>
                </form>
