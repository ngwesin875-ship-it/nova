                ...
                <form method="post" action="" class="p-5 space-y-5">
                    ...
                    <div class="grid md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" id="final_price_display" readonly value="$0.00" class="w-full px-4 py-2.5 border border-gray-200 bg-gray-50 rounded-lg text-gray-500 outline-none cursor-default">
