...
<body class="bg-slate-100">
    ...
    <div class="ml-64 flex flex-col h-screen">
        ...
        <?php $pageTitle = 'Create Plan'; include __DIR__ . '/../includes/admin-topbar.php'; ?>
                ...
                <form method="post" action="" class="px-3 py-2 text-xs space-y-5">
                    ...
                    <div class="grid md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="number" id="duration_months" name="duration_months" value="<?= (int) $durationMonths ?>" min="1" required class="w-full px-3 py-1.5 text-xs.5 border border-slate-200 rounded-xl border-slate-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none">
                        </div>
                        <div>
                            <label for="price" class="block text-xs font-semibold text-slate-900 mb-1">Price (MMK) <span class="text-red-600">*</span></label>
                            <input type="number" id="price" name="price" value="<?= htmlspecialchars($price) ?>" step="0.01" min="0.01" required oninput="calcFinal()" class="w-full px-3 py-1.5 text-xs.5 border border-slate-200 rounded-xl border-slate-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none">
                        </div>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="number" id="discount_percentage" name="discount_percentage" value="<?= htmlspecialchars($discountPercentage) ?>" step="0.01" min="0" max="100" oninput="calcFinal()" class="w-full px-3 py-1.5 text-xs.5 border border-slate-200 rounded-xl border-slate-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none">
                        ...
                        <div>
                            ...
                            <input type="text" id="final_price_display" readonly value="0 MMK" class="w-full px-3 py-1.5 text-xs.5 border border-slate-200 bg-slate-50/50 rounded-lg text-slate-500 outline-none cursor-default">
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        ...
                        <a href="plans.php" class="px-6 py-2.5 border border-slate-200 text-slate-900 rounded-lg font-semibold hover:bg-slate-50/50 transition-colors transition">Cancel</a>
                    </div>
                </form>
